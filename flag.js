    ...
    for (i = 0; i < flaglist.length; i++) {
      ...
      for (var j = 0; j < voterDetails.posts.length; j++) {
        ...
        if (process.env.ACTIVE !== undefined &&
          ...
          // comment on post
          var message = '@sadkitten is countering 85%% of @' + voterDetails.voter + ' self-votes for 1 week starting %s because it is part of last weeks top self-voters. For more details see [this post](https://steemit.com/steemit/@sadkitten/self-voter-return-on-investment-svroi-notoriety-flagging-bot).';
